...
var app = angular.module('GREP', ['ngMessages']);
var serverAddress = '';
var portNumber = '443'
...
function results($rootScope, $http) {
  ...
  img.addEventListener('load', function() {
    ...
    rt.results.faces.forEach(function(face, index) {
      ...
      var happiness_intensity = face.happiness_intensity;
    })
  ...
  res.save = function() {
    var fileName = 'grep_annotated_image.png'
  ...
  reader.addEventListener("load", function() {
    validfile = (function() {
      ...
      if (fileName == "") {
        ...
        return false;
      } else if (fileName.split(".").pop().toUpperCase() == "JPG" || fileName.split(".").pop().toUpperCase() == "PNG")
        return true;
      else {
        return false;
      }
