...
args.net_number = 6
args.data_path = '/Volumes/Extend/20170212Extend/Document/UNNC/Current/Year_4_Autumn/AE3IDS/Project/FYP/HappeiDetectedFaces/train_all_faces/'
args.test_set = 'train'
args.loss = 'softmax'
...
#         feature.append(out)
#     features.append({'name':test_set[ii]['filename'],'feature':feature,'label':test_set[ii]['label_index']})
#     ii+=1
#
# np.save('features/'+args.test_set+'_%dnets_feature.npy'%args.number_of_nets,features)
# print "done"
#
